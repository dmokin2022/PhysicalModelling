...
public:
  ...
  static physvalue sumR;  // сумма радиусов двух расчётных частиц
  static physvalue dx;  // разность по x между двумя расчётными частицами
  static physvalue dy;  // разность по y между двумя расчётными частицами
  static physvalue sqrL;  // квадрат расстояния между двумя расчётными частицами
  static physvalue L;  // расстояние между двумя расчётными частицами
